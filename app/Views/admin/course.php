...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <form action="<?= base_url('admin/update_course/' . $user['id']); ?>" method="post">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Trainer</label>
                    <input class="form-control" type="text" name="trainer" value="<?= $user['trainer']; ?>">
                  </div>
                </div>
              </div>
              <?php else : ?>
    ...
    <?php endif; ?>
              ...
              <p class="text-uppercase text-sm">Add User Progress</p>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Week</label>                 
  ...
  <option value="Week 4">Week 4</option>
              ...
              <hr class="horizontal dark">
              <p class="text-uppercase text-sm">Trainer's Note</p>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Notes</label>
                    <input class="form-control" name="notes" type="textarea">
                  </div>
