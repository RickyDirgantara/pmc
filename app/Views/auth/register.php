...
<?= $this->include('layouts/navbar') ?>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('auth/images/bg-01.jpg');">
			...
			<form class="login100-form validate-form" action="/doRegister" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Confirm password">
						<input class="input100" type="password" id="pass_confirm" name="pass_confirm" placeholder="Confirm Password">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					...
					<a class="txt1">
						...
						<a class="txt1 p-t-20" href="/login">
							Login
						</a>
					</div>
